(function ($) {
  ...
  $(".gx-side-overlay, .close-topic").on("click", function () {
  ...
  $(".gx-tools-item.mode").on("click", function () {
    ...
    if (modes == "light") {
      ...
      if (headerModes == "light") {
        ...
        $(".gx-tools-item.header[data-header-mode='dark']").removeClass(
          "active"
        );
      ...
      if (headerModes == "light") {
        ...
        $(".gx-tools-item.header[data-header-mode='light']").removeClass(
          "active"
        );
    ...
    $(this)
      .parents(".gx-tools-info")
      .find(".gx-tools-item.mode")
      .removeClass("active");
    $(this).addClass("active");
  });
  // Sidebar
